...
export type GenerateAppointmentSublineInput = z.infer<
  typeof GenerateAppointmentSublineInputSchema
>;
...
const GenerateAppointmentSublineOutputSchema = z.object({
  subline: z
    .string()
    .describe(
      'A short, catchy, and informative subline for the appointment, maximum 10 words.'
    ),
});
export type GenerateAppointmentSublineOutput = z.infer<
  typeof GenerateAppointmentSublineOutputSchema
>;
...
export async function generateAppointmentSubline(
  input: GenerateAppointmentSublineInput
): Promise<GenerateAppointmentSublineOutput> {
