...
const stats = [
  {
    title: 'AUSHÄNGE',
    value: '3',
    description: 'aktive Mitteilungen',
    icon: MessageSquare,
    color: 'text-blue-500',
  },
  {
  ...
  {
    title: 'GEPLANTE VERSAMMLUNGEN',
    value: '2',
    description: 'nächste 3 Monate',
    icon: Calendar,
...
const ownerAppointments = [
  {
    ...
    type: 'Versammlung',
    description:
      'Die jährliche Eigentümerversammlung findet im Gemeinschaftsraum statt. Die offizielle Einladung mit Tagesordnung wurde fristgerecht versendet.',
  ...
  },
  {
    ...
    type: 'Beiratssitzung',
    description:
      'Der Verwaltungsbeirat bespricht die anstehenden Themen für das vierte Quartal, inkl. Budgetplanung 2026.',
  ...
  },
  {
    ...
    type: 'Sonstiges',
    description:
      'Vor-Ort-Termin mit der Firma Dachprofi zur Begutachtung der gemeldeten Schäden am Hauptdach.',
...
const getTypeDetails = (type: string) => {
  switch (type) {
    ...
    case 'Gemeinschaft':
      return { icon: PartyPopper, color: 'bg-purple-100 text-purple-800' };
    case 'Versammlung':
      return { icon: Users, color: 'bg-blue-100 text-blue-800' };
    case 'Beiratssitzung':
      return { icon: UserCheck, color: 'bg-amber-100 text-amber-800' };
    default:
      return { icon: Info, color: 'outline' };
  }
};
  ...
  React.useEffect(() => {
    ...
    const demoAppointments = [
      ...
      },
      {
        ...
        type: 'Gemeinschaft',
        description:
          'Wir laden alle Bewohnerinnen und Bewohner herzlich zum diesjährigen Parkfest auf der Festwiese ein.',
        subline: 'Gemütliches Beisammensein für alle Nachbarn.',
      },
      {
        date: new Date(2025, 8, 15).toISOString(), // 15. September 2025
        ...
        type: 'Versammlung',
        description:
          'Die jährliche Eigentümerversammlung findet im Gemeinschaftsraum statt.',
        subline: 'Jährliches Treffen aller Eigentümer.',
      },
      {
        date: new Date(2025, 9, 5).toISOString(), // 5. Oktober 2025
        ...
        type: 'Beiratssitzung',
        description:
          'Der Verwaltungsbeirat bespricht die anstehenden Themen für das vierte Quartal.',
        subline: 'Interne Sitzung des Verwaltungsbeirats.',
      },
    ];
    ...
    <div className="container py-8">
      ...
      <div className="text-center max-w-2xl mx-auto my-8">
        ...
        <p className="mt-4 text-lg text-muted-foreground">
          Alle wichtigen Verwaltungsaufgaben und Termine der Bewohner &
          Eigentümer im Blick behalten.
        </p>
      </div>
          ...
          <CardHeader>
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Alle wichtigen Termine der Bewohner & Eigentümer
              </p>
            </div>
          </CardHeader>
          <CardContent>
                ...
                {upcomingAppointments.map((item, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <Badge
                        variant={
                          typeDetails.color.startsWith('bg-')
                            ? 'outline'
                            : (typeDetails.color as any)
                        }
                        className={
                          typeDetails.color.startsWith('bg-')
                            ? typeDetails.color
