    ...
    <div className="container py-8">
      ...
      <div className="text-center max-w-2xl mx-auto mb-12">
        ...
        <p className="mt-4 text-lg text-muted-foreground">
          Ihr zentraler Bereich für Dokumente, Termine und wichtige
          Informationen als Wohnungseigentümer.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 mb-12 max-w-4xl mx-auto">
        <DashboardCard
          ...
          description="Alle wichtigen Unterlagen wie Protokolle, Beschlüsse und Abrechnungen."
          iconBg="bg-blue-500"
        />
        <DashboardCard
          href="/appointments"
          ...
          description="Alle gemeinschaftlichen Termine und wichtigen Fristen im Blick."
        ...
        <DashboardCard
          ...
          icon={Megaphone}
          title="Aushangbrett"
          description="Aktuelle Mitteilungen der Verwaltung und des Beirats einsehen."
          iconBg="bg-cyan-500"
        />
        <DashboardCard
          href="/contact"
          ...
          description="Anliegen an die Verwaltung oder den Beirat senden."
          ...
          <CardHeader>
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Ihre wichtigsten Termine als Eigentümer
              </p>
            </div>
          </CardHeader>
          <CardContent>
