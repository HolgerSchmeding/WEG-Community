...
const initialResidentAppointments = [
  ...
  },
  {
    ...
    type: 'Offiziell',
    description:
      'Wichtige Versammlung zur Besprechung des Jahresabschlusses 2024 und Planung für 2025. Alle Eigentümer sind herzlich eingeladen.',
...
const getTypeDetails = (type: string) => {
  switch (type) {
    ...
    case 'Private Info':
      return { icon: User, color: 'bg-amber-100 text-amber-800' };
    default:
    ...
    try {
      ...
      if (storedAppointments) {
        ...
        localStorage.setItem(
          ...
          JSON.stringify(initialResidentAppointments)
        );
      }
    } catch (error) {
    ...
    <div className="container py-8">
      ...
      <div className="max-w-4xl mx-auto mt-8 text-center">
        ...
        <p className="mt-2 text-muted-foreground max-w-2xl mx-auto">
          Eine Übersicht aller wichtigen Termine, Ankündigungen und
          gemeinschaftlichen Events in der Wohnanlage.
        </p>
      </div>
          ...
          <CardContent>
            {isLoading ? (
              ...
              <div className="text-center py-12 text-muted-foreground">
                ...
                <p>
                  Derzeit sind keine spezifischen Termine für Bewohner geplant.
                </p>
              </div>
            )}
          </CardContent>
