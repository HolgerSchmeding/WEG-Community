  ...
  return (
    <div className="container py-8">
      ...
      <div className="max-w-4xl mx-auto space-y-12">
        <Card>
            <CardHeader>
                <CardTitle className="font-headline text-xl">Hausordnung der WEG Silberbach</CardTitle>
                <CardDescription>Stand: März 2024. Die wichtigsten Regeln für ein gutes nachbarschaftliches Miteinander.</CardDescription>
            </CardHeader>
            <CardContent>
                <Accordion type="single" collapsible className="w-full">
                    {houseRules.map((rule, index) => (
                        <AccordionItem value={`item-${index}`} key={index}>
                            <AccordionTrigger className="font-semibold text-base text-left">{rule.title}</AccordionTrigger>
