      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="mt-2 text-muted-foreground max-w-2xl mx-auto">
            Rechtliche Hinweise und wichtige Auszüge aus dem
            Wohnungseigentumsgesetz (WEG) speziell für Verwaltungsbeiräte.
          </p>
        </div>
          ...
          <div>
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Auszug aus dem Wohnungseigentumsgesetz (WEG) - § 27
                </CardDescription>
              </CardHeader>
              <CardContent>
