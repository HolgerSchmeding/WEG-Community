...
export default function ManageAnnouncementsPage() {
  ...
  const getStatusBadgeVariant = (status: string) => {
    switch(status) {
        case "Aktiv": return "secondary";
        case "Entwurf": return "outline";
        case "Abgelaufen": return "destructive";
  ...
  return (
    <div className="container py-8">
      ...
      <div className="flex justify-between items-center mt-8 mb-6">
        <div>
            <h1 className="font-headline text-3xl font-bold">Aushang-Verwaltung</h1>
            <p className="text-muted-foreground">Hier können Sie Aushänge erstellen, bearbeiten und veröffentlichen.</p>
        </div>
        <Button asChild>
                ...
                <TableRow key={item.id}>
                  ...
                  <TableCell>
                    <div className="flex flex-col gap-1">
                      {item.visibility.residents && <Badge variant="outline">Bewohner</Badge>}
                      {item.visibility.owners && <Badge variant="outline">Eigentümer</Badge>}
                    </div>
                  </TableCell>
