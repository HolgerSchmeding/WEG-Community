...
import { Save, Loader2, CalendarIcon, KeyRound, Users, UserCheck } from "lucide-react";
...
const appointmentSchema = z.object({
  ...
  visibility: z.array(z.string()).min(1, "Mindestens eine Rolle muss ausgewählt sein."),
      ...
      <div className="max-w-3xl mx-auto mt-8">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Füllen Sie die Felder aus, um den Termin zu erstellen oder zu aktualisieren.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="z.B. Eigentümerversammlung" {...field} />
                    </FormControl>
                  </FormItem>
                )}
              />
               ...
               <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea placeholder="Details zum Termin..." className="min-h-[150px]" {...field} />
                    </FormControl>
                  </FormItem>
                )}
              />
                              ...
                              render={({ field }) => {
                                return (
                                  <FormItem className="flex flex-row items-center space-x-3 space-y-0">
                                    ...
                                    <FormLabel className="font-normal">{roleLabels[role]}</FormLabel>
                                  </FormItem>
                                )
                              }}
                            />
                          ...
                          <FormItem>
                              ...
                              <FormControl>
                                  ...
                                  <FormItem className="flex items-center space-x-3 space-y-0">
                                      ...
                                      <FormLabel className="font-normal">Entwurf</FormLabel>
                                  </FormItem>
                                  <FormItem className="flex items-center space-x-3 space-y-0">
                                      <FormControl>
                                      <RadioGroupItem value="Anstehend" />
                                      </FormControl>
                                      <FormLabel className="font-normal">Veröffentlichen</FormLabel>
                                  </FormItem>
                                  </RadioGroup>
                              </FormControl>
                          </FormItem>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Interne Notizen (nicht öffentlich sichtbar)</FormLabel>
                    <FormControl>
                      <Textarea placeholder="z.B. Aufgaben, Erinnerungen..." {...field} />
                    </FormControl>
                  </FormItem>
                )}
              />
