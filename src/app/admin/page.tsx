...
const propertyManagementFunctions = [
  ...
  },
  {
    ...
    description:
      'Als Hausverwalter vor Ort Tickets für Reparaturen/Wartungen erfassen',
    icon: ClipboardList,
    bgColor: 'bg-blue-100',
  ...
  },
  {
    ...
    description:
      'Eigentümerversammlung digital protokollieren mit KI-Unterstützung',
    icon: FileText,
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="mt-2 text-muted-foreground max-w-3xl mx-auto">
              Zentrale Verwaltung der WEG-Community-Plattform. Verwalten Sie
              alle Aspekte der Plattform, einschließlich Benutzer, Inhalte und
              Systemeinstellungen.
            </p>
          </div>
          ...
          <section className="mb-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {overviewStats.map((stat, index) => (
                <Card
                  key={index}
                  className="bg-white/70 backdrop-blur-sm border-gray-200 shadow-sm"
                >
                ...
                <Link href={func.href} key={func.title}>
                  <Card className="bg-white/70 backdrop-blur-sm border-gray-200 shadow-sm hover:shadow-md hover:-translate-y-1 transition-transform duration-200 h-full flex flex-col">
                    <CardContent className="p-6 flex-grow flex flex-col justify-between">
                      <div>
                        <div
                          className={`w-12 h-12 rounded-lg flex items-center justify-center mb-4 ${func.bgColor}`}
                        >
          ...
          <section>
            <Accordion
              type="single"
              collapsible
              className="w-full bg-white/70 backdrop-blur-sm border-gray-200 shadow-sm rounded-lg"
            >
              <AccordionItem value="item-1" className="border-b-0">
                <AccordionTrigger className="p-6 hover:no-underline">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 className="font-headline text-lg font-semibold text-left">
                        KI-Admin-Assistent
                      </h3>
                      <p className="text-sm text-muted-foreground text-left">
                        Fragen zur Verwaltung? Klicken Sie hier, um den
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-700 mb-3">
                          Ein intelligenter Verwaltungsassistent kann für Ihre
                          WEG-Community aktiviert werden. Für optimale
                          Unterstützung erfolgt zunächst ein spezielles Training
                          mit Ihren spezifischen Hausverwaltungsdaten und
                          WEG-Regelwerken.
                        </p>
